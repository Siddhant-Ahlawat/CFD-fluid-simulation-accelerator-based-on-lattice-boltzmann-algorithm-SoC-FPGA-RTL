	Computer_System u0 (
		...
		.n0_from_fpga_export             (<connected-to-n0_from_fpga_export>),             //         n0_from_fpga.export
		.n0_from_hps_export              (<connected-to-n0_from_hps_export>),              //          n0_from_hps.export
		.ne_from_fpga_export             (<connected-to-ne_from_fpga_export>),             //         ne_from_fpga.export
		.ne_from_hps_export              (<connected-to-ne_from_hps_export>),              //          ne_from_hps.export
		.nn_from_fpga_export             (<connected-to-nn_from_fpga_export>),             //         nn_from_fpga.export
		.nn_from_hps_export              (<connected-to-nn_from_hps_export>),              //          nn_from_hps.export
		.nne_from_fpga_export            (<connected-to-nne_from_fpga_export>),            //        nne_from_fpga.export
		.nne_from_hps_export             (<connected-to-nne_from_hps_export>),             //         nne_from_hps.export
		.nnw_from_fpga_export            (<connected-to-nnw_from_fpga_export>),            //        nnw_from_fpga.export
		.nnw_from_hps_export             (<connected-to-nnw_from_hps_export>),             //         nnw_from_hps.export
		.ns_from_fpga_export             (<connected-to-ns_from_fpga_export>),             //         ns_from_fpga.export
		.ns_from_hps_export              (<connected-to-ns_from_hps_export>),              //          ns_from_hps.export
		.nse_from_fpga_export            (<connected-to-nse_from_fpga_export>),            //        nse_from_fpga.export
		.nse_from_hps_export             (<connected-to-nse_from_hps_export>),             //         nse_from_hps.export
		.nsw_from_fpga_export            (<connected-to-nsw_from_fpga_export>),            //        nsw_from_fpga.export
		.nsw_from_hps_export             (<connected-to-nsw_from_hps_export>),             //         nsw_from_hps.export
		.nw_from_fpga_export             (<connected-to-nw_from_fpga_export>),             //         nw_from_fpga.export
		.nw_from_hps_export              (<connected-to-nw_from_hps_export>),              //          nw_from_hps.export
		.omega_export                    (<connected-to-omega_export>),                    //                omega.export
		.one36th_export                  (<connected-to-one36th_export>),                  //              one36th.export
		.one9th_export                   (<connected-to-one9th_export>),                   //               one9th.export
		...
		.ux_export                       (<connected-to-ux_export>),                       //                   ux.export
		.uy_export                       (<connected-to-uy_export>),                       //                   uy.export
